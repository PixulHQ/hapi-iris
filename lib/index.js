...
exports.plugin = {
    ...
    register : async (server, options) => {
        ...
        internals.amqpConnection.on('log', server.log);
    }
};
...
internals.publish = async (params) => {
    ...
    publisher.on('log', (data) => internals.server.log(data));
...
internals.subscribe = (params) => {
    ...
    consumer.on('log', (data) => internals.server.log(data));
...
internals.publishRPC = (params) => {
    ...
    rpcPublisher.on('log', (data) => internals.server.log(data));
...
internals.subscribeRPC = (params) => {
    ...
    rpcConsumer.on('log', (data) => internals.server.log(data));
